...
export const aboutSections = [
  ...
  },
  {
    ...
    body: (
      <section
        className='w-full lg:w-[832px] text-sm sm:text-base lg:text-lg text-type-body leading-relaxed'
        style={{fontFamily: 'SejongGeulggot, Pretendard, sans-serif'}}>
  ...
  },
  {
    ...
    body: (
      <section
        className='w-full lg:w-[588px] text-sm sm:text-base lg:text-lg text-type-body leading-relaxed'
        style={{fontFamily: 'SejongGeulggot, Pretendard, sans-serif'}}>
