export const spaceEvents = [
  ...
  },
  {
    ...
    description:
      '창작 도서관의 희곡을 읽으며 휴식을 가집니다. 차분하고 안전한 공간에\n서 책과 함께 마음을 돌아보며, 책 속 마음에 남는 문장을 화분에\n담습니다. 화분을 꾸미고 씨앗을 심으며 완성된 화분은 집으로\n가져가 식물처럼 문장을 돌봅니다.',
    time: '12:00 - 18:00',
  ...
  },
  {
    ...
    description:
      '프로젝트 스페이스 코스모스에서 진행되는 관객참여형 공공미술\n프로젝트로, 오래된 돌계단에 돌탑을 쌓는 행위를 통해 참여자들이\n직접 작품의 일부가 되는 경험을 제공합니다.',
    time: '12:00 – 18:00',
